let join;_932‍.w('path',[["join",function(v){join=v}]]);let fetch;_932‍.w('isomorphic-fetch',[["default",function(v){fetch=v}]]);let name,internet,lorem,date,random;_932‍.w('faker',[["name",function(v){name=v}],["internet",function(v){internet=v}],["lorem",function(v){lorem=v}],["date",function(v){date=v}],["random",function(v){random=v}]]);let starwars;_932‍.w('starwars',[["default",function(v){starwars=v}]]);let promisify;_932‍.w('bluebird',[["promisify",function(v){promisify=v}]]);let mkdirp;_932‍.w('mkdirp',[["default",function(v){mkdirp=v}]]);let _;_932‍.w('lodash',[["default",function(v){_=v}]]);let uuid;_932‍.w('uuid/v4',[["default",function(v){uuid=v}]]);let writeFile;_932‍.w('fs',[["writeFile",function(v){writeFile=v}]]);let ora;_932‍.w('ora',[["default",function(v){ora=v}]]);
